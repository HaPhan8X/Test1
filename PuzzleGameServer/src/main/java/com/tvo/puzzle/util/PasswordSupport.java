...
public class PasswordSupport implements java.io.Serializable {
	...
	char[] ach5 = new char[] { '$', '%', '!', '#', '$', '%', '!', '#', '$', '%' };
	return (ach4[aNums[7]] + String.valueOf(aNums[2]) + ach1[aNums[3]] + String.valueOf(aNums[0]) + ach3[aNums[5]] + ach2[aNums[4]]
	...
	return new StringBuilder("PasswordSupport[").append("password=").append(password).append(", confirm=").append(confirm).append("]").toString();
    }

    public static void main(String[] as) {
	String a = getMD5Hash("admin");
	System.out.print(a);
    }
}
